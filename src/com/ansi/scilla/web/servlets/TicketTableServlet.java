...
public class TicketTableServlet extends AbstractServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int col = 0;
		String dir = "asc";
		String[] cols = { "ticket_id", "status", "bill_to_name", "job_site_name", "job_site_address", "start_date", "frequency", "price_per_cleaning", "job_number", "job_id", "description","process_date", "invoice_id" };
