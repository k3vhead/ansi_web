...
public class BcrEmployeesServlet extends AbstractServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			BudgetControlEmployeesResponse data = new BudgetControlEmployeesResponse(conn, sessionUser.getUserId(), divisionList, divisionId, workYear, workWeek);
