...
import com.ansi.scilla.web.bcr.response.BudgetControlActualDlResponse;
...
public class BcrActualDLServlet extends AbstractServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			BudgetControlActualDlResponse data = new BudgetControlActualDlResponse(conn, sessionUser.getUserId(), divisionList, divisionId, workYear, workWeek);
