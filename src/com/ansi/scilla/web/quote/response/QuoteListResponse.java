...
public class QuoteListResponse extends MessageResponse implements Serializable {
	 ...
	 * @throws Exception
	 */
	public QuoteListResponse(Connection conn, List<UserPermission> permissionList) throws Exception {
	...
	public QuoteListResponse(Connection conn, String quoteNumber, String revision, List<UserPermission> permissionList) throws Exception {
		Quote key = new Quote();
	...
	public QuoteListResponse(Connection conn, String quoteId, List<UserPermission> permissionList) throws Exception {
		Quote key = new Quote();
