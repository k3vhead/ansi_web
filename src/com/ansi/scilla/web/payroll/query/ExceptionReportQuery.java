...
public class ExceptionReportQuery extends LookupQuery {
	...
	private static final String sqlSelectClause = "select \n"
			...
			+ "	employee_company.group_id as employee_company_id,\n"
			+ "	employee_company.name as employee_company_name,\n"
			...
			+ "	CASE \n"
			+ "		when payroll_worksheet.division_id = employee_division.division_id then 0\n"
			+ "		else 1\n"
			+ "	end as foreign_division,\n"
			+ "	CASE \n"
			+ "		when company.group_id = employee_company.group_id then 0\n"
			+ "		else 1\n"
			+ "	end as foreign_company\n";
	...
	private static final String sqlFromClause =
			...
			+ "inner join payroll_worksheet on \n"
			+ "		payroll_worksheet.division_id = division.division_id \n"
			+ "		-- and payroll_worksheet.week_ending='2021-12-10'\n"
			...
			+ "inner join division_group as employee_company on employee_company.group_id = employee_division.group_id \n"
			+ "inner join (select\n"
			+ "		employee_code,\n"
