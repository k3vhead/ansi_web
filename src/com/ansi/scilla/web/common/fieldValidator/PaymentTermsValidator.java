...
public abstract class PaymentTermsValidator extends ApplicationObject implements FieldValidator {
	...
	public void validate(Connection conn, String fieldName, Object value, WebMessages webMessages) throws Exception {
		if ( value == null ) {
			...
			InvoiceTerm paymentTerm = InvoiceTerm.valueOf((String)value);
			if ( paymentTerm == null ) {
