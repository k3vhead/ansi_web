...
public class RequestValidator {
	...
	public static void main(String[] args) {
		...
		String x = InvoiceGrouping.BY_BILL_TO.name();
		String y = "abcdef";
		RequestValidator.validateInvoiceGrouping(webMessages, "invoiceGrouping", x, true);
		RequestValidator.validateInvoiceGrouping(webMessages, "invoiceGrouping", y, true);
...
//		RequestValidator.validateInvoiceTerms(webMessages, "invoiceTerms", this.invoiceTerms, true);
		...
		for ( String key : webMessages.keySet() ) {
			for ( String value : webMessages.get(key) ) {
