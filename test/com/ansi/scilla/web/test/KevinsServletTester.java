...
public class KevinsServletTester extends TestServlet {
	...
	public void go() throws Exception {
		...
		String pageContent1 = super.doPost(sessionCookie, "/ansi_web/report/DISPATCHED_OUTSTANDING_TICKET_REPORT", "{\"divisionId\":\"102\",\"endDate\":\"01/31/2018\",\"reportDisplay\":{\"ul\":\"accordionList\",\"li\":\"accordionItem\",\"titleTag\":\"h4\",\"titleClass\":\"accHdr\"}}");
		...
		HashMap<String, String> parmMap = super.makeParmMap(invoiceLookupParm);
		String pageContent2 = super.doGet(sessionCookie, "/ansi_web/invoiceLookup", parmMap);
