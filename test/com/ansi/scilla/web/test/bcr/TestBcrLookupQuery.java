...
//			System.out.println(response);
			...
			while (rs.next()) {
				System.out.println(rs.getInt(BcrTicketSql.CLAIM_ID) + "\t" + rs.getInt(BcrTicketSql.TICKET_ID) + "\t" + rs.getString("job_site_name") + "\t" + rs.getString(BcrTicketSql.CLAIMED_EQUIPMENT));
			}
			rs.close();
