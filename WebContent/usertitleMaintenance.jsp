    ...
    <tiles:put name="headextra" type="string">
        ...
        $(function() {        
			...
			$("#addButton").click( function($clickevent) {
				$clickevent.preventDefault();
				$("#addFormTitle").html("Add User Title");
             	$('#addFormDiv').bPopup({
					modalClose: false,
					opacity: 0.6,
					positionStyle: 'fixed' //'fixed' or 'absolute'
    	...
    	<ansi:hasPermission permissionRequired="SYSADMIN">
    		<ansi:hasWrite>
		    	<div id="confirmDelete">
		    		Are You Sure You Want to Delete this User Title?<br />
		    	...
		    	<div id="addFormDiv">
		    		...
		    		<form action="#" method="post" id="addForm">
		    			<table>
		    				...
		    				<tr>
		    					<td><span class="required">*</span><span class="formLabel">Title ID:</span></td>
		    					<td>
