    ...
    <tiles:put name="headextra" type="string">
       ...
       $(document).ready(function() {
			...
			; INVOICE_PRINT = {
				...
				init : function() {
					INVOICE_PRINT.makeClickers();	
		        	if ( INVOICE_PRINT.invoiceGenMessage != '' ) {
		        		$("#globalMsg").html(INVOICE_PRINT.invoiceGenMessage).show().fadeOut(6000);
		        	}
				},
		        	...
		        	$("#printAll").click(function($event) {
			         ...
			         var jqxhr = $.ajax({
			   			...
			   			success: function($data) {   				
			   				INVOICE_PRINT.populateDataTable($data.data);
			   			},
			   			statusCode: {
			   				403: function($data) {
					...
					var dataTable = $('#invoiceTable').DataTable( {
					        ...
					        columns: [
					            ...
					            "initComplete": function(settings, json) {
					            	INVOICE_PRINT.doFunctionBinding();
					            },
