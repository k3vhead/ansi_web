    ...
    <tiles:put name="headextra" type="string">
        ...
        $(function() {        
			...
			function doUpdate($clickevent) {
				...
				$("#addFormTitle").html("Update Print History");
			...
			$("#addButton").click( function($clickevent) {
				$clickevent.preventDefault();
				$("#addFormTitle").html("Add Print History");
             	$('#addFormDiv').bPopup({
					modalClose: false,
					opacity: 0.6,
					positionStyle: 'fixed' //'fixed' or 'absolute'
    	...
    	<ansi:hasPermission permissionRequired="SYSADMIN">
    		<ansi:hasWrite>
		    	<div id="confirmDelete">
		    		Are You Sure You Want to Delete this Print History?<br />
		    	...
		    	<div id="addFormDiv">
		    		...
		    		<form action="#" method="post" id="addForm">
		    			<table>
		    				<tr>
		    					<td><span class="required">*</span><span class="formLabel">Print Date:</span></td>
		    					<td>
		    				...
		    				<tr>
		    					<td><span class="required">*</span><span class="formLabel">Quote Date:</span></td>
		    					<td>
		    				...
		    				<tr>
		    					<td><span class="required">*</span><span class="formLabel">Quote ID:</span></td>
		    					<td>
