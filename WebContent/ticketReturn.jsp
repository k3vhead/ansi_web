    ...
    <tiles:put name="headextra" type="string">
        ...
        $(document).ready(function(){
	        ...
	        ;TICKETRETURN = {
			    ...
			    addRow : function (index, $ticket) {	
						var $rownum = index + 1;
		       			rowTd = TICKETRETURN.makeRow($ticket, $rownum);
			   	...
			   	makeClickers : function () {	
					...
					$(".goUpdate").click( function($clickevent) {
		            	...
		            	$url = "ticket/" + TICKETRETURN.globalTicketId;
		        	...
		        	$("#doPopulate").click(function () {
		    			...
		    			TICKETRETURN.globalTicketId = $('#ticketNbr').val();
		    			if ($ticketNbr != '') {            		
		        	...
		        	$("#ticketOverride").click(function($event) {
		        		location.href="ticketOverride.html?id="+TICKETRETURN.globalTicketId;
		        	});
		            ...
		            var $ticketComplete = $( "#ticketNbr" ).autocomplete({
		                ...
		                select: function( event, ui ) {
		                	...
		                	TICKETRETURN.globalTicketId = $ticketNbr
		        ...
		        populateDefaultTicketNbr : function () {    
			        	if ( TICKETRETURN.defaultTicketNbr != '' ) {
			        		$("#ticketNbr").val(TICKETRETURN.defaultTicketNbr);
			        		$("#doPopulate").click();
			        		$("#ticketNbr").focus();
			        	}
		        },
		...
		//					$($panelId).fadeIn(1500);
			   	...
			   	saveApprovals : function () {
		            	...
		            	$url = "ticketApprovalOverride/" + TICKETRETURN.globalTicketId;
