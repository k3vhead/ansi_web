...
<div <%= cssIdString %> <%= cssClassString %> >
	<div style="float:right;margin-right:6px; margin-top:6px;">
		<span id="<%=namespace %>_invoiceEdit" style="cursor:pointer;" class="green fa fa-pencil tooltip" ari-hidden="true"><span id="<%=namespace %>tooltiptext" class="tooltiptext">Edit</span></span>
	</div>
