<%@ tag description="" body-content="scriptless" %><%@ attribute name="styleClass" required="false" rtexprvalue="true" %><%@ attribute name="styleId" required="false" rtexprvalue="true" %><%@ attribute name="style" required="false" rtexprvalue="true" %><%@ attribute name="xrefType" required="true" rtexprvalue="true" %><%@ attribute name="xrefId" required="true" rtexprvalue="true" %><%@ attribute name="xrefName" required="false" rtexprvalue="true" %><%
...
%><span class="orange fas fa-music tooltip call-note-action-link <%= classString %>" data-xrefId="<%= xrefId %>" data-xrefType="<%= xrefType %>" <%= idString %> <%= styleString %> <%= xrefNameString %>ari-hidden="true"><span class="tooltiptext"><jsp:doBody /></span></span>