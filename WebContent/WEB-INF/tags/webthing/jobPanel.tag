		...
		<tr>
			<td class="jobTableCell" colspan="2" >
				...
				<div style="float:right; text-align:right;">
					...
					<i style="cursor:pointer;" class="clickableIcon, far fa-calendar  fa-3x tooltip" aria-hidden="true" id="<%= namespace %>_scheduleJobButton"><span class="tooltiptext">Schedule</span></i>
					<i style="cursor:pointer;" class="clickableIcon, far fa-trash-alt fa-3x tooltip" aria-hidden="true" id="<%= namespace %>_deleteJobButton"><span class="tooltiptext">Delete</span></i>
