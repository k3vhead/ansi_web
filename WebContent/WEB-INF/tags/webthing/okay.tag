...
%><span class="green fas fa-exclamation-triangle tooltip <%= classString %>" <%= idString %> <%= styleString %> <%=tabString %> ari-hidden="true"><span class="tooltiptext"><jsp:doBody /></span></span>