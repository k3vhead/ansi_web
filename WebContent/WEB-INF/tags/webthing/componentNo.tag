...
%><span class="fa-stack"><i class="red fas fa-ban fa-stack-2x"></i><span class="green fas fa-sitemap fa-stack-1x tooltip <%= classString %>" <%= idString %> <%= styleString %> <%=tabString %> ari-hidden="true"><span class="tooltiptext"><jsp:doBody /></span></span></span>