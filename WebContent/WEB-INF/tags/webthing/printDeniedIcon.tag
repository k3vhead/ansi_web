...
%><span class="fa-stack tooltip <%= classString %>" <%= idString %> <%= styleString %>><span class="green fa fa-print fa-stack-2x"></span><span class="red fas fa-ban fa-stack-1x fa-2x"><span class="tooltiptext"><jsp:doBody /></span></span></span>