...
%><span class="red fas fa-exclamation-circle tooltip <%= classString %>" <%= idString %> <%= styleString %> <%=tabString %> ari-hidden="true"><span class="tooltiptext"><jsp:doBody /></span></span>