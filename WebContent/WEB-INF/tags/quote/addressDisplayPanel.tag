...
<table id="<%= styleId %>" class="ansi-address-container">
	<tr>
		<td class="ansi-address-form-label-container"><span class="formLabel"><%= labelString %>:</span></td>
		<td colspan="3"><span class="ansi-address-name ansi-address-value" style="width:315px"></span></td>
	</tr>
	<tr>
		<td class="ansi-address-form-label-container"><span class="formLabel"><bean:message key="field.label.address" />:</span></td>
		<td colspan="3"><span class="ansi-address-address1 ansi-address-value" style="width:315px"></span></td>						
	</tr>
	<tr>
		<td class="ansi-address-form-label-container"><span class="formLabel"><bean:message key="field.label.address2" />:</span></td>
		<td colspan="3"><span class="ansi-address-address2 ansi-address-value" style="width:315px"></span></td>						
	</tr>
	<tr>
		<td class="ansi-address-form-label-container"><span class="formLabel"><bean:message key="field.label.city" />/<bean:message key="field.label.state" />/<bean:message key="field.label.zip" />:</span></td>
	...
	<tr>
		<td class="ansi-address-form-label-container"><span class="formLabel"><bean:message key="field.label.county" />:</span></td>
