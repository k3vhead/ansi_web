...
<table style="width:1100px;">
	<tr>
		...
		<td style="text-align:center;"><span  id="quoteLabel">Quote</span></td>
		<td style="text-align:center;"><span  id="revisionLabel">Revision</span></td>
	...
	<tr>
		...
		<td colspan="2">
			<span class="labelSpan">Building Type:</span>
