			        ...
			        columns: [
			            ...
			            { title: "<bean:message key="field.label.action" />",  data: function ( row, type, set ) {	
			            	...
			            	if ( row.ticketId == null ) {
			            		...
			            		var $claimLink = '<ansi:hasPermission permissionRequired="CLAIMS_WRITE"><a href="budgetControlLookup.html?id='+row.ticketId+'"><webthing:invoiceIcon styleClass="green">Claim</webthing:invoiceIcon></a></ansi:hasPermission>';
