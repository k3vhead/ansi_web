        		...
        		makeTable : function(){
            		TICKETASSIGNMENTLOOKUP.dataTable = $('#ticket-assignment-table').DataTable( {
    			        ...
    			        columns: [
    			            ...
    			            { width:"4%", title: "Start Date", "defaultContent": "<i>N/A</i>", searchable:true, searchFormat: "MM/dd/YYYY", data: function ( row, type, set ) {
    			            ...
    			            { width:"7%", title: "Washer",  "defaultContent": "<i>N/A</i>", searchable:true, searchFormat: "#####", data: function ( row, type, set ) {
