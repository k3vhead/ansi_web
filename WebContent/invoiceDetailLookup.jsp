...
<tiles:insert page="layout.jsp" flush="true">
	        	        ...
	        	        buttons: [
	        	        	...
	        	        	{extend: 'colvis',	label: function () {doFunctionBinding();}},
	        	        	{
	        	        		...
	        	        		action: function(e, dt, node, config) {
	        	        			...
	        	        			var $url = "invoiceDetailLookup.html?divisionId=" + $filterDivisionId + "&ppcFilter=" + $filterPPC;
	        	        			location.href=$url;
	        	        		}
	        	        	}
	        	        ],
	...
	//         	            { "orderable": false, "targets": -1 },  // Need to re-add this when we add the action column back in
				        ...
				        columns: [
				            ...
				            { title: "Invoice PPC",  "defaultContent": "<i>N/A</i>", data: function ( row, type, set ) {
				            ...
				            { title: "Job Site Address",  "defaultContent": "<i>-</i>", data: function ( row, type, set ) {
				            ...
				            { title: "Completed",  "defaultContent": "<i>N/A</i>", data: function ( row, type, set ) {
				            ...
				            { title: "Taxes",  "defaultContent": "<i>N/A</i>", data: function ( row, type, set ) {
				            ...
				            { title: "Paid",  "defaultContent": "<i>N/A</i>", data: function ( row, type, set ) {
				            	if(row.paid != null){return (row.paid.toFixed(2));}
				            } },
				            { title: "Due",  "defaultContent": "<i>N/A</i>", data: function ( row, type, set ) {
