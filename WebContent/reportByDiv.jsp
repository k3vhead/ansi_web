        	...
        	;REPORT_BY_DIV = {
        		...
        		reportType : "<c:out value="${com_ansi_scilla_report_type}" />",
       			...
       			go : function($clickEvent) {
       				...
       				var $url = "report/" + REPORT_BY_DIV.reportType;
       				var $outbound = {'divisionId':$divisionId, 'reportDisplay':$reportDisplay};
       				var $downloadUrl = $url+"?divisionId=" + $divisionId;       				
